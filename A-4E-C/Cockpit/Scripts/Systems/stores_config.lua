...
loadout_names = {
    ...
    ["{DB769D48-67D7-42ED-A2BE-108D566C8B1E}"]  = "BOMB - GBU-12 - 500 LB. LASER GUIDED",
    ["{0D33DDAE-524F-4A4E-B5B8-621754FE3ADE}"]  = "BOMB - GBU-16 - 1000 LB. LASER GUIDED",
    ["{51F9AAE5-964F-4D21-83FB-502E3BFE5F8A}"]  = "BOMB - GBU-10 - 2000 LB. LASER GUIDED",
    ...
    ["{GBU-12_TER_2_L}"]                         = "BOMBS - GBU-12 - 500 LB. LASER GUIDED - TER",
    ["{GBU-12_TER_2_R}"]                         = "BOMBS - GBU-12 - 500 LB. LASER GUIDED - TER",
    ["{GBU-12_TER_3_C}"]                         = "BOMBS - GBU-12 - 500 LB. LASER GUIDED - TER",
